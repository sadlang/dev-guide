...
بعد [توحيد هاش/شفر](crypto-unification.md) (`هاش`/`شفر`/`فك_تشفير` في وحدة `تأكيدات`)، وُسِّعت
...
العمل على هدف الوضع الحرّ (نفس قيد [[crypto-unification|توحيد هاش/شفر]])، وسطح
...
كلّ واحد يُشغَّل عبر `sad-run.exe` **و**`sad-build.exe` ويُقارَن الناتج حرفيًّا —
...
---
**اقرأ بعده:** [توحيد هاش/شفر/فك_تشفير](crypto-unification.md) ·
